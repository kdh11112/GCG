...
<body>
	<form id="frm" name="frm" enctype="multipart/form-data">
		<table class="board_view">
			...
			<tbody>
				...
				<tr>
					<td colspan="4" class="view_text"><textarea rows="20" cols="100" title="내용" id="CONTENTS" name="CONTENTS">${map.CONTENTS }</textarea>
					</td>
				</tr>
				<tr>
					...
					<td colspan="3">
						<div id="fileDiv">
							<c:forEach var ="row" items="${list }" varStatus="var">
								...
								<p><input type="hidden" id="IDX" name="IDX_${var.index }" value="${row.IDX }">
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$("a[name^='delete']").on("click",function(e){// 파일추가 버튼에 있는 삭제 버튼
				e.preventDefault();
				fn_deleteFile($(this));	
